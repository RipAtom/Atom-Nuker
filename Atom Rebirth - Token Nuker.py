...
class Jajaja:
    ...
    def input_loop(self):
        ...
        print(self.display_banner() + f'''
            [{Fore.YELLOW}1{Fore.RESET}] Atom Rebirth - Advanced Token Nuker
            [{Fore.YELLOW}2{Fore.RESET}] Atom Rebirth - Advanced Token Login
            [{Fore.YELLOW}3{Fore.RESET}] Atom Rebirth - Advanced Token Info
...
if __name__ == '__main__':
    token = Jajaja.ask(f'[{Fore.YELLOW}>{Fore.RESET}] Atom Rebirth Client > Input Your Discord Token')
    threads = Jajaja.ask(f'[{Fore.YELLOW}>{Fore.RESET}] Atom Rebirth Client > Input Your Amount Of Threads')
    ...
    input('\nYou may now press enter to close Atom Rebirth v1.1.7...\n')
